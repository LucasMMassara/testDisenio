...
public class DepartamentoJpaController implements Serializable {
    ...
    public void create(Departamento departamento) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findDepartamento(departamento.getDomicilio()) != null) {
    ...
    public void edit(Departamento departamento) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Domicilio id = departamento.getDomicilio();
    ...
    public void destroy(Domicilio id) throws NonexistentEntityException {
        destroy(id.getId());
    }
    ...
    public Departamento findDepartamento(Domicilio id) {
        return findDepartamento(id.getId());
    }
