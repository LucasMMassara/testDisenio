...
public class ValorSiniestro {
	...
	private List<ValorSiniestroHistorial> historial;
	...
	public List<ValorSiniestroHistorial> getHistorial() {
		return historial;
	}
	public void setHistorial(List<ValorSiniestroHistorial> historial) {
